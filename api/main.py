...
from api.routers import people, companies, stats, graph, query, analytics, network, recruiter_workflow, ai, market_intelligence, cache, advanced_search, github_ingestion, network_enhanced, market_intelligence_enhanced, profile_enrichment, github, discovery, market_analytics_deep, notifications, github_intelligence, graph_reasoning
...
app.include_router(graph_reasoning.router)  # Advanced graph reasoning and network analysis
